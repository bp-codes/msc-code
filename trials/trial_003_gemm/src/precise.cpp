...
Matrix<__float128> precise(__float128 alpha, const Matrix<__float128>& A,
                           const Matrix<__float128>& B, __float128 beta,
...
int main(int argc, char** argv) {
    ...
    Matrix<__float128> X_expected = precise(k, A, B, l, C);
    ...
    // Output
    {
        const std::string base_file_name =
            "results/precise_" + matrix_size + "_" + std::string(operation_string);
