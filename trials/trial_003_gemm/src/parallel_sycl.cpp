...
void task(sycl::queue& q, double alpha, const double* A, const double* B, double beta,
          const double* C, std::size_t M, std::size_t N, std::size_t K, double* X) {
...
int main(int argc, char** argv) {
    ...
    // Output
    {
        const std::string base_file_name =
            "results/parallel_sycl_" + matrix_size + "_" + std::string(operation_string);
