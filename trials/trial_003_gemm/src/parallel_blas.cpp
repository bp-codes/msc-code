...
Matrix<double> task(const double alpha, const Matrix<double>& A, const Matrix<double>& B,
                    const double beta, const Matrix<double>& C) {
...
int main(int argc, char** argv) {
    ...
    const auto method{std::string("Parallel BLAS")};
    const auto comments{std::string("operation:") + std::string(operation_string)};

    // Output
    {
        const std::string base_file_name =
            "results/parallel_blas_" + matrix_size + "_" + std::string(operation_string);
