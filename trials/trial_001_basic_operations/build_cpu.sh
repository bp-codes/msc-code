...
trap 'echo "Error on line $LINENO (exit code $?)" >&2' ERR
{
    ...
    #g++ -O3 -ffast-math -march=native -std=c++23 -ltbb -pthread src/parallel_stl.cpp -o bin/parallel_stl.x
    ...
    g++ -O3 -ffast-math -march=native -std=c++23 -fopenmp src/openmp_32.cpp -o bin/openmp_32.x
    g++ -O3 -ffast-math -march=native -std=c++23 -fopenmp src/openmp_simd_32.cpp -o bin/openmp_simd_32.x
