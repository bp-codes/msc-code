...
auto main(int argc, char** argv) -> int {
    try {
        ...
        // Copy once
        cuda_check(cudaMemcpyAsync(dev_a, numbers_a.data(), n * sizeof(double),
                                   cudaMemcpyHostToDevice, stream),
                   "cudaMemcpyAsync dev_a failed.");
        cuda_check(cudaMemcpyAsync(dev_b, numbers_b.data(), n * sizeof(double),
                                   cudaMemcpyHostToDevice, stream),
        ...
        // Copy results back
        cuda_check(cudaMemcpyAsync(numbers_c.data(), dev_c, n * sizeof(double),
