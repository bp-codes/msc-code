 ...
 */
void parallel_add(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b,
                  std::vector<double>& numbers_c) {
    std::transform(std::execution::par, numbers_a.begin(), numbers_a.end(), numbers_b.begin(),
                   numbers_c.begin(), [](double x, double y) { return x + y; });
}

/**
 * @brief Element-wise multiplication: c[i] = a[i] * b[i]
 */
void parallel_multiply(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b,
                       std::vector<double>& numbers_c) {
    std::transform(std::execution::par, numbers_a.begin(), numbers_a.end(), numbers_b.begin(),
                   numbers_c.begin(), [](double x, double y) { return x * y; });
}
 ...
 */
void parallel_divide(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b,
                     std::vector<double>& numbers_c) {
    std::transform(std::execution::par, numbers_a.begin(), numbers_a.end(), numbers_b.begin(),
                   numbers_c.begin(),
 ...
 */
void parallel_power(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b,
                    std::vector<double>& numbers_c) {
    std::transform(std::execution::par, numbers_a.begin(), numbers_a.end(), numbers_b.begin(),
                   numbers_c.begin(), [](double x, double y) { return std::pow(x, y); });
}

/**
 * @brief Element-wise exp sum: c[i] = exp(a[i]) + exp(b[i])
 */
void parallel_exp(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b,
                  std::vector<double>& numbers_c) {
    std::transform(std::execution::par, numbers_a.begin(), numbers_a.end(), numbers_b.begin(),
                   numbers_c.begin(), [](double x, double y) { return std::exp(x) + std::exp(y); });
}
 ...
 */
void parallel_log(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b,
                  std::vector<double>& numbers_c) {
    std::transform(std::execution::par, numbers_a.begin(), numbers_a.end(), numbers_b.begin(),
                   numbers_c.begin(), [](double x, double y) { return std::log(x) + std::log(y); });
}
 ...
 * @warning Inputs must be >= 0. No bounds/validity checking is performed in this hot loop.
 */
void parallel_sqrt(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b,
                   std::vector<double>& numbers_c) {
    std::transform(std::execution::par, numbers_a.begin(), numbers_a.end(), numbers_b.begin(),
                   numbers_c.begin(),
 ...
 */
void parallel_task(OperationKind operation, const std::vector<double>& numbers_a,
    ...
    try {
        ...
        // Output
        {
            const std::string base_file_name =
                "results/parallel_stl_" + std::string(operation_string);
