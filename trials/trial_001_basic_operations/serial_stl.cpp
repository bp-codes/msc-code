...
void serial_stl_add(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b, std::vector<double>& numbers_c)
{
    std::transform(
...
void serial_stl_multiply(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b, std::vector<double>& numbers_c)
{
    std::transform(
        numbers_a.begin(), numbers_a.end(),
        numbers_b.begin(),
...
void serial_stl_divide(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b, std::vector<double>& numbers_c)
{
...
void serial_stl_power(const std::vector<double>& numbers_a, const std::vector<double>& numbers_b, std::vector<double>& numbers_c)
{
    for(std::size_t i = 0; i <numbers_a.size(); i++)
    {
...
void serial_stl_task(const std::string& operation, const std::vector<double>& numbers_a, const std::vector<double>& numbers_b, std::vector<double>& numbers_c)
{
    if(operation == "add") serial_stl_add(numbers_a, numbers_b, numbers_c);
    if(operation == "multiply") serial_stl_multiply(numbers_a, numbers_b, numbers_c);
    if(operation == "divide") serial_stl_divide(numbers_a, numbers_b, numbers_c);
    if(operation == "power") serial_stl_power(numbers_a, numbers_b, numbers_c);
}
...
int main(int argc, char** argv) 
{
    ...
    do 
    {
        serial_stl_task(operation, numbers_a, numbers_b, numbers_c);
        iters++;
    } 
