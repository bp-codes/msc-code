...
int main(int argc, char** argv) 
{
    ...
    // Output
    {
        const auto method {std::string("Parallel OpenMP Reduction SIMD 32")};
        const auto operation_string = std::string("sum");
        const auto comments {std::string("operation:") + std::string(operation_string)};

        const std::string base_file_name = "results/parallel_openmp_reduction_simd_32_" + operation_string;
