...
public:
    ...
    static void run(std::string& input_file) {
        ...
        // Heat grid
        Heat::heat_grid_sycl(sycl_engine, model_grid, sources, dt, t_final, snapshot_every, outdir,
                             prefix, queue_output);
...
private:
     ...
     */
    static void heat_grid_sycl(SyclEngine& sycl_engine, Grid& model_grid,
