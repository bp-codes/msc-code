...
public:
     ...
     */
    void enqueue(std::string prefix, std::filesystem::path outdir, double t, std::size_t step,
                 const Grid& grid) {
     ...
     */
    void enqueue(const std::string& prefix, const std::filesystem::path& outdir, const double t,
...
public:
     ...
     */
    static void grid_to_csv(const std::string& prefix, const std::filesystem::path& outdir,
                            double t, std::size_t step, const Grid& grid_data) {
        std::ostringstream oss;
        oss << prefix << "_" << std::setw(6) << std::setfill('0') << step << ".csv";
     ...
     */
    static void grid_to_csv(const double t, const Grid& grid_data,
