...
Usage examples:
  ...
  python plot_heat.py outputheat_*.csv --frame 0

  # Animate all frames interactively
  python plot_heat.py outputheat_*.csv --animate

  # Save MP4 (needs ffmpeg installed)
  python plot_heat.py outputheat_*.csv --animate --save movie.mp4

  # Save GIF (no ffmpeg required if pillow installed)
  python plot_heat.py outputheat_*.csv --animate --save movie.gif
...
def main():
    ...
    ap.add_argument("pattern", help="Glob pattern for CSV files, e.g. outputheat_*.csv")
