...
public:
     ...
     */
    template <typename Rep, typename Period>
    inline void update_making_neighbour_list(const std::chrono::duration<Rep, Period>& time_elapsed)
    {
     ...
     */
    template <typename Rep, typename Period>
    inline void update_updating_neighbour_list(const std::chrono::duration<Rep, Period>& time_elapsed)
    {
